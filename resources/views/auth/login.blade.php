...
<html lang="en">
	...
	<head>
		...
		<link href="{{asset('admin/assets/css/demo1/pages/login/login-1.css')}}" rel="stylesheet" type="text/css" />
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
					...
					<div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url({{asset('admin/assets/media//bg/bg-4.jpg')}});">
						...
						<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
							<div class="kt-grid__item kt-grid__item--middle">
								<h3 class="kt-login__title">Welcome to Go Promax!</h3>
		...
		<script src="{{asset('admin/assets/js/demo1/pages/login/login-1.js')}}" type="text/javascript"></script>
